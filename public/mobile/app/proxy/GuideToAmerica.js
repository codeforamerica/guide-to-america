/**
 * @class Ext.data.GuideToAmericaProxy
 * @extends Ext.data.proxy.JsonP
 *
 * This simple proxy allows us to use GuideToAmerica's JSON-P API to search for tweets. All we're really doing in this
 ...
 *
 */
Ext.define('GuideToAmerica.proxy.GuideToAmerica', {
    extend: 'Ext.data.proxy.JsonP',
    alias: 'proxy.GuideToAmerica',
    
    config: {
        // This is the url we always query when searching for tweets
//        url: 'http://search.GuideToAmerica.com/search.json',
